  ...
  return (
    <div className='2xl:h-[110vh] xl:h-[100vh] lg:h-[85vh] md:h-[70vh] sm:h-[140vh] h-[100vh] relative font-[Helvetica] w-full bg-black text-white'>
      ...
      <div className="main lg:h-[90vh] h-full flex md:flex-row flex-col-reverse md:justify-between justify-end items-center 2xl:px-32 xl:px-28 lg:p-24 md:p-12 relative w-full">
        <div className="image absolute lg:right-80 md:right-40 right-20 top-[-120px] h-full lg:w-[37%] w-[50%] z-10">
        ...
        <div className="left flex flex-col xl:gap-10 lg:gap-8 md:gap-6 gap-6 md:w-1/2 w-full items-center md:items-start relative z-20">
          ...
          <div className="para 2xl:w-[43%] lg:w-[80%] md:w-[90%] w-[70%] text-center md:text-start md:text-sm lg:text-base sm:text-lg text-base text-[#959292]">
            A Series of Bengal Pattachitra Art to
          ...
          <div className="buttons flex justify-center md:pt-0 pt-5 md:justify-start lg:gap-8 gap-4 items-center xl:w-[67%] lg:w-[80%] md:w-[80%] w-full">
