    ...
    return (
        <div className='w-[85%] flex justify-between items-center font-[Helvetica] bg-[#F5F5F5] py-5 rounded-xl px-20'>
            <div className="imageselements flex justify-center items-center gap-14">
                <div className="img">
                    <img className='w-[9vw] h-[28vh]' src={image} alt="" />
                </div>
                <div className='flex flex-col gap-5'>
                    <h1 className='text-3xl font-bold'>{title}</h1>
                    <div className="elements flex justify-start items-center gap-1">
                        <div className="num text-xl">{quantity}</div>
                        <div className='img1 flex flex-col gap-0.5'>
                            <img className='w-[10px]' src="src/assets/Vector.png" alt="" />
                            <img className='w-[10px]' src="src/assets/Vector (1).png" alt="" />
                        </div>
                    </div>
            ...
            <div className="delete">
                <img className='w-[1.5vw] h-[4vh]' src="src/assets/bin.png" alt="" />
            </div>
        </div>
    )
}
