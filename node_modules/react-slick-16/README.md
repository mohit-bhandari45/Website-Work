...
[![Join the chat at https://gitter.im/akiran/react-slick-16](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/akiran/react-slick-16?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
### [Demos](http://neostack.com/opensource/react-slick-16)

### [PlayGround](https://jsfiddle.net/kirana/20bumb4g/)
Use [jsfiddle template](https://jsfiddle.net/kirana/20bumb4g/) to try react-slick-16 with different settings.
...
### Starter Kit
Checkout [yeoman generator](https://github.com/akiran/generator-react-slick-16) to quickly
get started with react-slick-16.

### Example

```js
var React = require('react');
var Slider = require('react-slick-16');
...
| nextArrow      | React Element | Use this element for the next arrow button [Example](https://github.com/akiran/react-slick-16/blob/master/examples/CustomArrows.js) | Yes |
| prevArrow      | React Element | Use this element for the prev arrow button [Example](https://github.com/akiran/react-slick-16/blob/master/examples/CustomArrows.js) | Yes |
| autoplay       | bool | Should the scroller auto scroll? | Yes |
| autoplaySpeed  |  int | delay between each auto scoll. in ms | Yes |
| centerMode     | bool | Should we centre to a single item? | Yes |
| centerPadding  | | | |
| cssEase        | | | |
| customPaging   | func | Custom paging templates. [Example](https://github.com/akiran/react-slick-16/blob/master/examples/CustomPaging.js)| Yes |
...
### Methods
* `slickNext()`   - function called to change current slide on next slide ([Example](https://github.com/akiran/react-slick-16/blob/master/examples/PreviousNextMethods.js))
* `slickPrev()`   - function called to change current slide on previous slide ([Example](https://github.com/akiran/react-slick-16/blob/master/examples/PreviousNextMethods.js))
* `slickGoTo(slideNumber)` - function called to change current slide to given slide number ([Example](https://github.com/akiran/react-slick-16/blob/master/examples/SlickGoTo.js))
...
### Test Setup
If you try to run tests with jest in a project that uses react-slick-16, you may run into this error
```
...
```bash
git clone https://github.com/akiran/react-slick-16
npm install
npm start
...
<a target='_blank' rel='nofollow' href='https://app.codesponsor.io/link/8Wa5rFgnuaoyA8ryN2LAAqgu/akiran/react-slick-16'>
  <img alt='Sponsor' width='888' height='68' src='https://app.codesponsor.io/embed/8Wa5rFgnuaoyA8ryN2LAAqgu/akiran/react-slick-16.svg' />
</a>
