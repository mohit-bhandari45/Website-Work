...
const Story = ({mainimage,image,name,para}) => {
    return (
        <div className="img1 md:h-[53vh] xl:h-[94vh] w-[23vw] relative py-20 top-0 hover:scale-105 transition-all duration-100 ease-in-out cursor-pointer">
            <img className='absolute top-20 md:h-[45vh] xl:h-[75vh] w-full' src={mainimage} alt="" />
