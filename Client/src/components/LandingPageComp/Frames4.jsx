    ...
    return (
        <div className='h-full w-full font-[Helvetica] flex flex-col justify-center items-center py-8'>
            ...
            <div className='w-[90%] flex flex-col lg:flex-row justify-start items-center gap-8 mt-8'>
                <div className="h-full lg:w-[45%] bg-black box-border px-5 py-5 rounded-lg text-white gap-2 flex flex-col relative justify-end items-start">
                ...
                <div className="h-full lg:w-[55%] box-border flex flex-col gap-8">
                    ...
                    <div className='h-[50%] w-full flex flex-col lg:flex-row justify-center items-center gap-10'>
                        <div className="lg:w-1/2 bg-black h-full rounded-md relative flex flex-col justify-end py-4 px-4">
                        ...
                        <div className="lg:w-1/2 bg-black h-full rounded-lg flex justify-center items-center">
