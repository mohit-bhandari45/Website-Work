...
const Signup = () => {
    ...
    return (
        <>
            <div className="absolute w-[100vw] h-[100vh] top-0 flex justify-center items-center opacity-85 bg-black z-30">
            </div>
            <div className="absolute w-[100vw] h-[100vh] top-0 flex justify-center items-center z-30">
