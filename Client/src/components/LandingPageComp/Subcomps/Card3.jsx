...
const Card3 = ({ img, discount, title, mainprice, prevprice, stars, amount }) => {
    ...
    return (
        <div className='h-full w-[21vw] rounded-lg relative flex flex-col justify-center items-center font-[Helvetica]'>
            <div
                ...
                className="card h-[50vh] w-full bg-[#F5F5F5] relative flex justify-center items-center cursor-pointer hover:scale-95 transition-all ease-in-out duration-500"
            >
                ...
                <div className={`add absolute bottom-0 bg-black text-white w-full justify-center flex py-4 rounded-b-md text-xl transition-all duration-700 ease-in-out ${visible ? 'opacity-100' : 'opacity-0'}`}>
                    Add to Cart
                </div>
            </div>
