...
useEffect(() => {
    ...
    return (
        <>
            <div className={visible?"form opacity-100 absolute border rounded-3xl ml-24 form bg-[#e9d7b5] w-[480px] h-[530px]":"form opacity-0 absolute border rounded-3xl ml-24 form bg-[#e9d7b5] w-[480px] h-[530px]"}>
                <div className='relative mt-6 flex flex-col justify-center items-center'>
                    ...
                    <form onSubmit={handleSubmit} className='relative flex flex-col h-[180px]' action="">
                        ...
                        <input className={bool?"absolute top-[175px] border-none opacity-0 bg-[#ec8a73] text-white w-[380px] flex justify-center items-center py-4 font-semibold text-2xl border rounded-2xl mb-10 mt-10 transiton-all duration-150":"absolute top-[175px] border-none opacity-100 bg-[#ec8a73] text-white w-[380px] flex justify-center items-center py-4 font-semibold text-2xl border rounded-2xl mb-10 mt-10 transiton-all duration-150"} type="submit" value="Signup" />
                        <input className={bool?"absolute top-[175px] border-none opacity-100 bg-[#ec8a73] text-white w-[380px] flex justify-center items-center py-4 font-semibold text-2xl border rounded-2xl mb-10 mt-10 transiton-all duration-150":"absolute top-[175px] border-none opacity-0 bg-[#ec8a73] text-white w-[380px] flex justify-center items-center py-4 font-semibold text-2xl border rounded-2xl mb-10 mt-10 transiton-all duration-150"} type="submit" value="Login" />
